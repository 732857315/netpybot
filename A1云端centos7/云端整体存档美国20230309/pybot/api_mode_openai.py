...
api_key = "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"
#pybot_openai_key.apikey(2)
...
#msg="请用C语言写一个霍夫曼编码。"
def api_openai_chatgpt3turbo0301(msg):
...
def api_openai_credit_grants():
    #api_key = pybot_openai_key.apikey()
